...
{
    public class ClienteAlterarResquest
    {
        ...
        public ValidationResult ValidationResult
        {
            get
            {
                var erros = new ClienteAlterarResquestValidor().Validate(this).Errors;
    ...
    public class ClienteAlterarResquestValidor : AbstractValidator<ClienteAlterarResquest>
    {
        public ClienteAlterarResquestValidor()
        {
            RuleFor(c => c.Nome)
        ...
        {
            var result = await ValidateAsync(ValidationContext<ClienteAlterarResquest>.CreateWithOptions((ClienteAlterarResquest)model, x => x.IncludeProperties(propertyName)));
            if (result.IsValid)
            {
                return [];
            }
