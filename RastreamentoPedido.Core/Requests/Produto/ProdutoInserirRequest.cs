...
namespace RastreamentoPedido.Core.Requests.Produto
{
    public class ProdutoInserirRequest
    {
        ...
        public ValidationResult ValidationResult
        {
            get
            {
                var erros = new ProdutoRequestValidor().Validate(this).Errors;
    ...
    public class ProdutoRequestValidor : AbstractValidator<ProdutoInserirRequest>
    {
        public ProdutoRequestValidor()
        {
            RuleFor(p => p.Nome)
